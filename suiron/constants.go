...
func (a Atom) RecreateVariables(m map[Variable]Variable) Expression {
    return a;
}
...
// A constant is not a variable, so this function simply returns
// the constant. This function satisfies the Expression interface.
func (i Integer) RecreateVariables(m map[Variable]Variable) Expression {
    return i;
}
...
// A constant is not a variable, so this function simply returns
// the constant. This function satisfies the Expression interface.
func (f Float) RecreateVariables(m map[Variable]Variable) Expression {
    return f;
}
